...
export const Button: React.FC<ButtonProps> = ({ 
    ...
    return (
        <button 
            className={`h-[55px] flex items-center justify-center gap-2 min-w-fit rounded-lg px-3 py-2 outline-none rounded-lg border-2 border-secondary-color bg-${bgColor} shadow-md
