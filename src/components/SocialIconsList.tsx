...
export const SocialIconsList: React.FC<SocialIconsListProps> = ({ style }) => {
    return (
        <div className={`flex justify-center items-center gap-7 mt-5 ${style}`}>
            <a href='mailto:anabscarmoni@gmail.com' target='_blank' className="transition-all duration-300 hover:text-secondary-color focus:text-secondary-color cursor-pointer">
